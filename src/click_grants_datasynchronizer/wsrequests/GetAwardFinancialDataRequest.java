 ...
 * @author Glenn
 */
public class GetAwardFinancialDataRequest implements WebServiceRequest {
    ...
    public GetAwardFinancialDataRequest(int startRow, int numRows, String svcSessionToken) {
    ...
    public HttpURLConnection getConnection() throws Exception {
        ...
        content = "svcSessionToken=" + URLEncoder.encode(svcSessionToken) +
                "&savedSearchName=Award_FinancialFund_Export" +
