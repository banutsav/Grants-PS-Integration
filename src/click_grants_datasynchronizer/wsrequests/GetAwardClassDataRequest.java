 ...
 * @author Glenn
 */
public class GetAwardClassDataRequest implements WebServiceRequest {
    ...
    public GetAwardClassDataRequest(int startRow, int numRows, String svcSessionToken) {
    ...
    public HttpURLConnection getConnection() throws Exception {
        ...
        content = "svcSessionToken=" + URLEncoder.encode(svcSessionToken) +
                "&savedSearchName=Award_Class_Export" +
