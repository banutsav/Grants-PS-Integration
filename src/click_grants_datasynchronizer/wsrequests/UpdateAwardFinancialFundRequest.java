...
import click_grants_datasynchronizer.AwardFinancialFund;
 ...
 * @author Glenn
 */
public class UpdateAwardFinancialFundRequest implements WebServiceRequest {

    private AwardFinancialFund obj;
    private String svcSessionToken;
    private String content;

    public UpdateAwardFinancialFundRequest(AwardFinancialFund obj, String svcSessionToken) {
        this.obj = obj;
    ...
    public HttpURLConnection getConnection() throws Exception {
        final String requestXmlString
                = "<WebServiceRoot>"
                + "   <WebService Name='Award_FinancialFund_Upload'>"
                + "       <Attribute Caption='Fund Code' DataType='String' ReferenceType='' ReadOnly='False' Required='False' Value='" + StringEscapeUtils.escapeXml(obj.Fund_Code) + "'/>"
